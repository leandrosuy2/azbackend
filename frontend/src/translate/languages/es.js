    ...
    traducciones: {
      ...
      contacts: {
        ...
        toasts: {
          ...
          bulkDeleted: "{{count}} contacto(s) eliminado(s).",
          importFromPhone:
            "Importación desde el teléfono finalizada. La lista se actualizó.",
          importChatsRequested:
            "Solicitud de importación de chats enviada. La lista se actualizará en breve.",
          importExcelSuccess: "Hoja importada con éxito.",
        },
        ...
        pagination: {
          ...
          displayedRowsUnknown: "{{from}}–{{to}} de muchos",
        },
        bulkDelete: {
          menu: "Eliminar…",
          deleteSelected: "Eliminar seleccionados",
          deleteFiltered: "Eliminar filtro actual ({{count}})",
          deleteAllCompany: "Eliminar todos de la empresa",
          confirmSelectedTitle: "¿Eliminar seleccionados?",
          confirmSelected: "Se eliminarán {{count}} contacto(s) marcados en esta página.",
          confirmFilteredTitle: "¿Eliminar filtro actual?",
          confirmFiltered:
            "Se eliminarán todos los contactos que coincidan con la búsqueda y etiquetas ({{count}} en total).",
          confirmAllTitle: "¿Eliminar todos los contactos?",
          confirmAll:
            "Se eliminarán TODOS los {{count}} contacto(s) de la empresa. Esta acción no se puede deshacer.",
          noSelection: "Marca al menos un contacto en esta página.",
          selectPage: "Seleccionar todos en esta página",
        },
      },
      forwardMessage: {
        text: "Reenviado",
      ...
      contactModal: {
        ...
        form: {
          ...
          phonePlaceholder: "(DDD) 99999-9999 o +55 (DDD) …",
          numberLookupHint:
            "Al salir del campo, el sistema busca un contacto con el mismo número y completa nombre y correo si lo encuentra.",
          email: "Correo electrónico",
          emailPlaceholder: "nombre@empresa.com",
          document: "CPF o CNPJ",
          documentHint:
            "Solo números: 11 dígitos (CPF) o 14 (CNPJ). La máscara se aplica sola.",
          documentPlaceholder: "000.000.000-00 o 00.000.000/0000-00",
          documentInvalid: "El CPF/CNPJ debe tener 11 o 14 dígitos (o déjelo vacío).",
      ...
      tagModal: {
        title: {
          ...
          addKanban: "Nueva columna del Kanban",
          editKanban: "Editar columna del Kanban",
        },
        form: {
          name: "Nombre",
          color: "Color",
          ...
          kanbanColumn: {
            ...
            namePlaceholder: "Ej.: Por hacer, En curso, Finalizado",
            colorLabel: "Color de la columna",
            sectionBoard: "Tablero",
            boardLabel: "Tablero (Kanban)",
            boardHelper: "Esta columna solo se muestra en este tablero.",
            sectionAutomation: "Automatización (opcional)",
            timeHoursLabel: "Tiempo (horas) para mover automáticamente",
            timeHoursHelper:
              "Tras ese tiempo, la tarjeta pasa a otra columna.",
            nextColumnLabel: "Mover a qué columna",
            nextColumnNone: "— Ninguna —",
            nextColumnBoardHint: "Seleccione un tablero para ver sus columnas.",
            sectionMessage: "Mensaje automático (opcional)",
            greetingLabel: "Mensaje al entrar en la columna",
            greetingHelper:
              "Ej.: “Su proyecto entró en la etapa de producción.”",
            sectionReopen: "Al reabrir la atención",
            rollbackCheckbox: "Volver a esta columna al reanudar",
            rollbackHelper:
              "Al reabrir, la tarjeta vuelve automáticamente a esta columna.",
            legacyRollbackHint:
              "Hay retorno a otra etapa. Desmarque y guarde para quitar.",
          },
        },
        buttons: {
          okAdd: "Agregar",
      ...
      ticketsQueueSelect: {
        ...
        selectedCount: "{{count}} colas",
        createTooltip: "Crear nueva conexión de atención",
        createAria: "nueva conexión",
      },
      tickets: {
        inbox: {
          toolbarActions: "Atajos de lista",
          toolbarActionsShow: "Mostrar acciones (visibilidad, nuevo ticket, pestañas…)",
          toolbarActionsHide: "Ocultar acciones",
          toolbarActionsHintOpen: "Toca para plegar",
          toolbarActionsHintClosed: "Visibilidad, tickets, pestañas y orden",
          inboxCategoriesLabel: "Categorías",
          inboxFolderTags: "Etapas del embudo",
          createCategoryTooltip: "Crear categoría",
          createCategoryAria: "Crear categoría",
          createStageTooltip: "Crear etapa del embudo",
          createStageAria: "Crear etapa del embudo",
          inboxAddCategoryButton: "Añadir",
          inboxAddStageButton: "Añadir etapa",
          inboxManageButton: "Gestionar",
          inboxSeeMore: "Ver más ({{count}})",
          manageTagsTooltip: "Gestionar categorías y etapas (editar, eliminar)",
          manageTagsAria: "Gestionar categorías y etapas del embudo",
          manageTagsDialogTitle: "Gestionar categorías y etapas",
          manageTagsDialogHint:
            "Edite o elimine aquí para no saturar la bandeja. Los chips pasan a varias líneas; el resto va a “Ver más”. Arrastre por el icono para reordenar dentro de Categorías o dentro de Etapas del embudo.",
          manageDragReorderTooltip: "Arrastrar para reordenar",
          manageReorderSaved: "Orden guardado.",
          editCategoryTooltip: "Editar categoría",
          deleteCategoryTooltip: "Eliminar categoría",
          editStageTooltip: "Editar etapa del embudo",
          deleteStageTooltip: "Eliminar etapa",
          manageTagsCategoriesHeading: "Categorías",
          manageTagsStagesHeading: "Etapas del embudo",
          quickStageTitle: "Nueva etapa del embudo",
          quickStageName: "Nombre de la etapa",
          quickStageColor: "Color",
          quickStageFilterOnlyHint:
            "Estas etapas solo filtran la bandeja; no son columnas del Kanban.",
          quickStageSuccess: "Etapa de filtro creada correctamente.",
          deleteFunnelStageTitle: "¿Eliminar etapa de filtro?",
          deleteFunnelStageAction: "Eliminar etapa",
          deleteFunnelStageConfirm:
            "¿Eliminar la etapa \"{{name}}\"? Se quitarán los vínculos con contactos. Esta acción no se puede deshacer.",
          deleteCategoryTitle: "¿Eliminar categoría?",
          deleteCategoryAction: "Eliminar categoría",
          deleteCategoryConfirm:
            "¿Eliminar la categoría \"{{name}}\"? Se quitarán los vínculos con contactos. Esta acción no se puede deshacer.",
          quickStageBoard: "Tablero (Kanban)",
          quickStageNewBoard: "Nombre del tablero",
          quickStageNewBoardHint:
            "No hay tablero. Se creará automáticamente con este nombre.",
          quickStageDefaultBoardName: "Embudo",
          quickStageSubmit: "Crear etapa",
          quickStageNameShort: "Indique al menos 3 caracteres en el nombre de la etapa.",
          quickStageBoardNameShort: "Indique al menos 2 caracteres para el tablero.",
          quickStageSelectBoard: "Seleccione en qué tablero se creará la etapa.",
          showFilters: "Ver filtros",
          hideFilters: "Ocultar filtros",
          applyFilters: "Aplicar",
          clearFilters: "Limpiar filtros",
          filterLabelStatus: "Estado",
          filterLabelAttendant: "Agente",
          filterLabelChannel: "Canal",
          filterLabelTags: "Etiquetas",
        ...
        categoryAutocompletePlaceholder: "Categoría",
        categoryNameTooShort: "El nombre de la categoría es demasiado corto (mínimo 3 caracteres).",
        toasts: {
      ...
      mainDrawer: {
        ...
        appBar: {
          user: {
            ...
            companyNameFallback: "tu empresa",
            active: "Activo hasta",
            goodMorning: "Hola,",
            myName: "mi nombre es",
      ...
      helps: {
        ...
        areaLabels: {
          dashboard: "Dashboard / Informes",
          moments: "Atenciones en tiempo real",
          tickets: "Atenciones",
          ...
          campaigns: "Campañas",
          "campaigns-config": "Configuración de campañas",
          ...
          "queue-integration": "Integraciones",
          files: "Archivos",
          budgets: "Presupuestos / OS",
          settings: "Configuraciones",
          companies: "Empresas",
        },
        settings: {
      ...
      tagsKanban: {
        ...
        quadroSelectorLabel: "Tablero",
        quadroSelectorHelper: "Cada tablero tiene sus propias columnas.",
        boardsLanding: {
          searchPlaceholder: "Buscar tableros por nombre…",
          searchAria: "Búsqueda rápida de tableros",
          noResults: "No se encontró ningún tablero. Prueba otra palabra clave.",
        },
        laneDefault: "Sin etapa",
        confirmationModal: {
          deleteTitle: "¿Eliminar esta columna?",
          deleteMessage: "Esta acción no se puede deshacer.",
        },
        table: {
      ...
      messagesList: {
        header: {
          ...
          notAssigned: "Sin responsable",
          funnelLabel: "Embudo",
          kanbanStageLabel: "Etapa del tablero",
          dialogRatingTitle:
