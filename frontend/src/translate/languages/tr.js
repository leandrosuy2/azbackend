    ...
    translations: {
      ...
      contacts: {
        ...
        toasts: {
          ...
          bulkDeleted: "{{count}} kişi silindi.",
          importFromPhone:
            "Telefon rehberi içe aktarıldı. Kişi listesi yenilendi.",
          importChatsRequested:
            "Sohbet içe aktarma isteği gönderildi. Liste kısa süre içinde yenilenecek.",
          importExcelSuccess: "Tablo başarıyla içe aktarıldı.",
        },
        ...
        pagination: {
          ...
          displayedRowsUnknown: "{{from}}–{{to}} / çok",
        },
        bulkDelete: {
          menu: "Sil…",
          deleteSelected: "Seçilenleri sil",
          deleteFiltered: "Filtreyi sil ({{count}})",
          deleteAllCompany: "Şirketteki tüm kişileri sil",
          confirmSelectedTitle: "Seçilenleri sil?",
          confirmSelected: "Bu sayfada işaretli {{count}} kişi silinecek.",
          confirmFilteredTitle: "Filtreyi sil?",
          confirmFiltered:
            "Arama ve etiketlere uyan tüm kişiler silinecek (toplam {{count}}).",
          confirmAllTitle: "Tüm kişileri sil?",
          confirmAll:
            "Şirketteki TÜM {{count}} kişi silinecek. Bu işlem geri alınamaz.",
          noSelection: "Bu sayfada en az bir kişi seçin.",
          selectPage: "Bu sayfadakilerin tümünü seç",
        },
      },
      forwardMessage: {
        text: "İletildi",
      ...
      contactModal: {
        ...
        form: {
          ...
          name: "İsim",
          number: "İletişim numarası",
          phone: "Telefon / WhatsApp",
          phonePlaceholder: "(DDD) 99999-9999 veya +55 (DDD) …",
          numberLookupHint:
            "Alandan çıkınca sistem aynı numaralı kişiyi arar; bulursa ad ve e-postayı doldurur.",
          email: "E-posta",
          emailPlaceholder: "isim@sirket.com",
          document: "CPF veya CNPJ",
          documentHint:
            "Yalnızca rakamlar: 11 (CPF) veya 14 (CNPJ). Maske otomatik uygulanır.",
          documentPlaceholder: "000.000.000-00 veya 00.000.000/0000-00",
          documentInvalid: "CPF/CNPJ 11 veya 14 hane olmalı (veya boş bırakın).",
          extraName: "Alan adı",
          extraValue: "Değer",
      ...
      tagModal: {
        title: {
          ...
          addKanban: "Yeni Kanban sütunu",
          editKanban: "Kanban sütununu düzenle",
        },
        form: {
          name: "İsim",
          color: "Renk",
          ...
          kanbanColumn: {
            ...
            nameLabel: "Sütun adı",
            namePlaceholder: "Örn.: Yapılacaklar, Devam ediyor, Bitti",
            colorLabel: "Sütun rengi",
            sectionBoard: "Pano",
            boardLabel: "Pano (Kanban)",
            boardHelper: "Bu sütun yalnızca bu panoda görünür.",
            sectionAutomation: "Otomasyon (isteğe bağlı)",
            timeHoursLabel: "Otomatik taşıma için süre (saat)",
            timeHoursHelper:
              "Bu süre sonunda kart başka bir sütuna taşınır.",
            nextColumnLabel: "Hangi sütuna taşınsın",
            nextColumnNone: "— Yok —",
            nextColumnBoardHint: "Sütunları görmek için bir pano seçin.",
            sectionMessage: "Otomatik mesaj (isteğe bağlı)",
            greetingLabel: "Sütuna girerken mesaj",
            greetingHelper:
              "Örn.: “Projeniz üretim aşamasına girdi.”",
            sectionReopen: "Görüşme yeniden açılınca",
            rollbackCheckbox: "Hizmet sürdürülünce bu sütuna dön",
            rollbackHelper:
              "Görüşme yeniden açıldığında kart bu sütuna döner.",
            legacyRollbackHint:
              "Başka bir aşamaya dönüş ayarlı. Kaldırmak için işareti kaldırıp kaydedin.",
          },
        },
        buttons: {
          okAdd: "Ekle",
        ...
        successKanban: "Sütun başarıyla kaydedildi.",
      },
      fileModal: {
        title: {
      ...
      ticketsQueueSelect: {
        ...
        selectedCount: "{{count}} kuyruk",
        createTooltip: "Yeni hizmet bağlantısı oluştur",
        createAria: "yeni bağlantı",
      },
      tickets: {
        inbox: {
          toolbarActions: "Liste kısayolları",
          toolbarActionsShow: "İşlemleri göster (görünürlük, yeni talep, sekmeler…)",
          toolbarActionsHide: "İşlemleri gizle",
          toolbarActionsHintOpen: "Daraltmak için dokun",
          toolbarActionsHintClosed: "Görünürlük, talepler, sekmeler ve sıra",
          inboxCategoriesLabel: "Kategoriler",
          inboxFolderTags: "Huni aşamaları",
          createCategoryTooltip: "Kategori oluştur",
          createCategoryAria: "Kategori oluştur",
          createStageTooltip: "Huni aşaması oluştur",
          createStageAria: "Huni aşaması oluştur",
          inboxAddCategoryButton: "Ekle",
          inboxAddStageButton: "Aşama ekle",
          inboxManageButton: "Yönet",
          inboxSeeMore: "Daha fazla ({{count}})",
          manageTagsTooltip: "Kategorileri ve aşamaları yönet (düzenle, sil)",
          manageTagsAria: "Gelen kutusu kategorileri ve huni aşamalarını yönet",
          manageTagsDialogTitle: "Kategoriler ve huni aşamaları",
          manageTagsDialogHint:
            "Bandı düzenli tutmak için buradan düzenleyin veya silin. Etiketler satırlara bölünür; fazlası “Daha fazla”da açılır. Sırayı değiştirmek için simgeyi sürükleyin (Kategoriler veya Huni aşamaları içinde).",
          manageDragReorderTooltip: "Sürükleyerek sırala",
          manageReorderSaved: "Sıra kaydedildi.",
          editCategoryTooltip: "Kategoriyi düzenle",
          deleteCategoryTooltip: "Kategoriyi sil",
          editStageTooltip: "Huni aşamasını düzenle",
          deleteStageTooltip: "Aşamayı sil",
          manageTagsCategoriesHeading: "Kategoriler",
          manageTagsStagesHeading: "Huni aşamaları",
          quickStageTitle: "Yeni huni aşaması",
          quickStageName: "Aşama adı",
          quickStageColor: "Renk",
          quickStageFilterOnlyHint:
            "Bu aşamalar yalnızca gelen kutusu filtresi içindir; Kanban sütunu değildir.",
          quickStageSuccess: "Filtre aşaması oluşturuldu.",
          deleteFunnelStageTitle: "Filtre aşamasını sil?",
          deleteFunnelStageAction: "Aşamayı sil",
          deleteFunnelStageConfirm:
            "\"{{name}}\" aşaması silinsin mi? Kişi bağlantıları kaldırılır. Bu işlem geri alınamaz.",
          deleteCategoryTitle: "Kategoriyi sil?",
          deleteCategoryAction: "Kategoriyi sil",
          deleteCategoryConfirm:
            "\"{{name}}\" kategorisi silinsin mi? Kişi bağlantıları kaldırılır. Bu işlem geri alınamaz.",
          quickStageBoard: "Pano (Kanban)",
          quickStageNewBoard: "Pano adı",
          quickStageNewBoardHint:
            "Henüz pano yok. Bu adla otomatik oluşturulacak.",
          quickStageDefaultBoardName: "Huni",
          quickStageSubmit: "Aşama oluştur",
          quickStageNameShort: "Aşama adı en az 3 karakter olmalı.",
          quickStageBoardNameShort: "Pano adı en az 2 karakter olmalı.",
          quickStageSelectBoard: "Aşamanın hangi panoda oluşturulacağını seçin.",
          showFilters: "Filtreleri göster",
          hideFilters: "Filtreleri gizle",
          applyFilters: "Uygula",
          clearFilters: "Temizle",
          filterLabelStatus: "Durum",
          filterLabelAttendant: "Temsilci",
          filterLabelChannel: "Kanal",
          filterLabelTags: "Etiketler",
        ...
        categoryAutocompletePlaceholder: "Kategori",
        categoryNameTooShort: "Kategori adı çok kısa (en az 3 karakter).",
        toasts: {
      ...
      mainDrawer: {
        ...
        appBar: {
          user: {
            ...
            companyNameFallback: "işletmenize",
      ...
      helps: {
        ...
        areaLabels: {
          dashboard: "Dashboard / Raporlar",
          moments: "Gerçek zamanlı hizmet",
          tickets: "Destek kayıtları",
          notifications: "Bildirimler",
          "quick-messages": "Hızlı yanıtlar",
          kanban: "Kanban",
          connections: "Bağlantılar",
          "all-connections": "Tüm bağlantılar",
          contacts: "Kişiler",
          "contact-lists": "Kişi listeleri",
          tags: "Etiketler",
          schedules: "Planlamalar",
          chats: "Dahili sohbet",
          helps: "Yardım",
          tutorials: "Eğitimler",
          campaigns: "Kampanyalar",
          "campaigns-config": "Kampanya ayarları",
          flowbuilder: "Akış oluşturucu",
          announcements: "Duyurular",
          "messages-api": "Mesaj API",
          users: "Kullanıcılar ve izinler",
          queues: "Kuyruklar / Chatbot",
          prompts: "Prompts / OpenAI",
          "queue-integration": "Entegrasyonlar",
          files: "Dosyalar",
          budgets: "Bütçeler / İş emirleri",
          settings: "Ayarlar",
          companies: "Şirketler",
        },
        settings: {
      ...
      tagsKanban: {
        ...
        quadroSelectorLabel: "Pano",
        quadroSelectorHelper: "Her panonun kendi sütunları vardır.",
        boardsLanding: {
          searchPlaceholder: "Panoları ada göre ara…",
          searchAria: "Hızlı pano araması",
          noResults: "Pano bulunamadı. Başka bir anahtar kelime deneyin.",
        },
        laneDefault: "Aşama yok",
        confirmationModal: {
          deleteTitle: "Bu sütunu silmek istiyor musunuz?",
          deleteMessage: "Bu işlem geri alınamaz.",
        },
        table: {
          name: "Sütun adı",
        ...
        toasts: {
          deleted: "Sütun başarıyla silindi.",
        },
      },
      files: {
        title: "Dosya Listesi",
