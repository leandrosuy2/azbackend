...
const TicketActionButtonsCustom = ({
    ticket,
    /** Mesmo contato do painel/MessageInput — evita `ticket.contact` desatualizado após socket. */
    contact: contactFromParent,
    // , showSelectMessageCheckbox,
    // selectedMessages,
    // forwardMessageModalOpen,
    // setForwardMessageModalOpen
}) => {
    const contact = contactFromParent ?? ticket?.contact;
    ...
    const [budgetOrcamentoOpen, setBudgetOrcamentoOpen] = useState(false);
        ...
        <>
            {ticket?.id && (
                <BudgetOrcamentoModal
                    open={budgetOrcamentoOpen}
                    onClose={() => setBudgetOrcamentoOpen(false)}
                    ticket={ticket}
                    contact={contact}
                    user={user}
                    editBudgetId={null}
            ...
            <div className={classes.actionButtons}>
                ...
                {ticket?.id && (
                    <IconButton
                        className={classes.bottomButtonVisibilityIcon}
                        onClick={() => setBudgetOrcamentoOpen(true)}
                    >
                ...
                >
                    ...
                    <MenuItem onClick={() => { setBudgetOrcamentoOpen(true); handleCloseMenu(); }}>
                        Criar orçamento
                    </MenuItem>
                </Menu>
            </div>
